...
$.get('http://172.23.68.200:5001/api/v1/status/', function (data, status) {
  if (data.status === 'OK') {
...
fetch('http://172.23.68.200:5001/api/v1/places_search/', {
  method: 'POST',
  ...
  data.forEach(place => {
    $.get('http://172.23.68.200:5001//api/v1/users/' + place.user_id, function (user, status) {
